	...
	<div class="col-md-2" style="padding-left: 20px;">
		<ul class="nav nav-pills nav-stacked text-center">
	        ...
	        <li><a href="editSubCategoryPage">Edit Sub-Category</a></li>
	   	    ...
	   	    <li class="active"><a href="deleteSubCategoryPage">Remove Sub-Category</a></li>
		</ul>
	</div>
    <div class="col-md-10">
		<div class="row">
...
%>
				...
				<form class="form-horizontal" action="deleteSubCategory" method="post">
...
%>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="hidden" class="form-control" name="subCategoryName" value='<%=subCategoryName %>'>
							<input type="text" class="form-control" disabled="disabled" name="subCatName" value='<%=subCategoryName %>'>
						</div>
					</div>
